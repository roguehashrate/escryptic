...
/* package escryptic-0.1.0.0 */
#ifndef VERSION_escryptic
#define VERSION_escryptic "0.1.0.0"
#endif /* VERSION_escryptic */
#ifndef MIN_VERSION_escryptic
#define MIN_VERSION_escryptic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_escryptic */
...
#define CURRENT_COMPONENT_ID "escryptic-0.1.0.0-inplace-escryptic"
